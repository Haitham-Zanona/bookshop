...
$rocket_cookie_hash = 'f0ef482a16fdab8760abd8a01e366775';
$rocket_logged_in_cookie = 'wordpress_logged_in_f0ef482a16fdab8760abd8a01e366775';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_cache_mobile = 1;
$rocket_do_caching_mobile_files = 1;
$rocket_cache_reject_uri = '/bookshop(/(?:.+/)?feed(?:/(?:.+/?)?)?$|/(?:.+/)?embed/|/checkout/(.*)|/cart/|/my-account/(.*)|/wc-api/v(.*)|/(index\.php/)?(.*)wp\-json(/.*|$)|/wishlist/(.*)|/compare/(.*))';
